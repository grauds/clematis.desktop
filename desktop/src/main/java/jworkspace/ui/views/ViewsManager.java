...
public class ViewsManager extends AbstractViewsManager
{
    ...
    public CButton[] getButtons()
    {
         ...
         * Back button.
         */
        CButton b_back = WorkspaceUtils.createCButtonFromAction
                (actions.getAction(ViewsActions.browseBackActionName));
        /**
         * Forward button.
         */
        CButton b_forward = WorkspaceUtils.createCButtonFromAction
                (actions.getAction(ViewsActions.browseForwardActionName));
        /**
         * Add desktop.
         */
        CButton b_add = WorkspaceUtils.createCButtonFromAction
                (actions.getAction(ViewsActions.addDesktopActionName));
        /**
         * View desktop properties.
         */
        CButton b_prop = WorkspaceUtils.createCButtonFromAction
                (actions.getAction(ViewsActions.propertiesActionName));
        /**
         * Delete desktop.
         */
        CButton b_delete = WorkspaceUtils.createCButtonFromAction
    ...
    public JMenu[] getMenu()
    {
         ...
         * Back action.
         */
        go_back = WorkspaceUtils.createMenuItem
                (actions.getAction(ViewsActions.browseBackActionName));
        go.add(go_back);
        /**
         * Forward action.
         */
        go_forward = WorkspaceUtils.createMenuItem
                (actions.getAction(ViewsActions.browseForwardActionName));
        go.add(go_forward);
        go.addSeparator();
        /**
         ...
         * Add desktop.
         */
        new_desktop = WorkspaceUtils.createMenuItem
                (actions.getAction(ViewsActions.addDesktopActionName));
        go.add(new_desktop);
        /**
         * Delete desktop.
         */
        delete_view = WorkspaceUtils.createMenuItem
                (actions.getAction(ViewsActions.removeViewActionName));
        go.add(delete_view);
        go.addSeparator();
        /**
         * Reload current view.
         */
        reload_view = WorkspaceUtils.createMenuItem
                (actions.getAction(ViewsActions.reloadViewActionName));
        go.add(reload_view);
        /**
         * Saves current view.
         */
        save_view = WorkspaceUtils.createMenuItem
                (actions.getAction(ViewsActions.saveViewActionName));
        go.add(save_view);
        /**
         * View desktop properties.
         */
        properties = WorkspaceUtils.createMenuItem
                (actions.getAction(ViewsActions.propertiesActionName));
        go.add(properties);
        go.addSeparator();
    ...
    private JCheckBoxMenuItem getToggleHeaderMenuItem()
    {
        ...
        {
            toggle_header = WorkspaceUtils.createCheckboxMenuItem
    ...
    {
        if (getCurrentDesktop() == null) return;
    ...
    public void setCurrentView(int index)
    {
         ...
         */
        if ((Component) views.elementAt(currentView) instanceof IView)
        {
            try
            {
         ...
         */
        if ((Component) views.elementAt(index) instanceof IView)
        {
            /**
             * Notify component that it became active.
             */
        ...
        for (int i = 0; i < views.size(); i++)
        {
            if (views.elementAt(i) instanceof Desktop)
            {
                String viewSavePath = getPath() +
                        File.separator + "view_" + Integer.toString(counter);
                File file1 = new File(Workspace.getUserHome() +
                                      getPath() + File.separator +
                                      "view_" + Integer.toString(counter));
                if (!file1.exists())
                {
                  file1.mkdirs();
                }
    ...
    public void setViewsList(String[] names, int selected)
    {
        ...
        for (int i = 0; i < names.length; i++)
        {
            ...
            if (i == selected) item.setSelected(true);
        }
    }
}
