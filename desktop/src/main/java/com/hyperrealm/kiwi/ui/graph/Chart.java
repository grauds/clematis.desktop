...
public class Chart {
    ...
    static final int MAXIMUM_PRECISION = 10;

    static final double DEFAULT_TICK_INTERVAL = 10.0;

    private static final double MINIMUM_TICK_INTERVAL = 0.01;
    ...
    public void setTickInterval(double interval) {
        if (interval < MINIMUM_TICK_INTERVAL) {
