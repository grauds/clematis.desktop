...
import java.io.File;
/**
 * Authentication of server users. Server users can be of two different
 * kinds - admins and common users.
 */
public class ServerUsersManager extends AbstractUsersManager
{
  /**
   * Empty default constructor
   */
   public ServerUsersManager()
   {
      super();
      load();
   }
