...
import com.hyperrealm.kiwi.ui.ImageView;
...
import jworkspace.util.JarResourceLoader;
 ...
 */
public abstract class Workbench extends KPanel implements ListSelectionListener {
    /**
     * Installer window
     */
     ...
     * Content tree
     */
    protected KTreeTable contentTree = null;
    /**
...
//    installer.beginProcess();
     ...
     * created.
     */
    protected KTreeTable initContentTree(DefaultKTreeModel model) {

        if (contentTree == null) {
            contentTree = new KTreeTable();
            contentTree.getSelectionModel()
                    .setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
            contentTree.getSelectionModel().addListSelectionListener(this);
            contentTree.setRootVisible(true);
            contentTree.setTreeModel(model);
        }
        return contentTree;
    }
     ...
     */
    public abstract KTreeTable getContentTree();
     ...
     * @return javax.swing.JEditorPane
     */
    public RTextScrollPane getSourceViewer(String text, String name) {
        ...
        syntaxTextArea.setName(name);

        RTextScrollPane pane = new RTextScrollPane(syntaxTextArea);
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (e.getSource() instanceof KTreeTable &&
                e.getSource() == contentTree) {

            TreePath p = ((KTreeTable)e.getSource()).getSelectionPath();
            boolean nosel = (p == null);
            currentNode = (nosel ? null : (DefinitionNode) p.getLastPathComponent());
            /**
