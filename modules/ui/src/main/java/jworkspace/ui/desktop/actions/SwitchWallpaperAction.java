...
public class SwitchWallpaperAction extends AbstractDesktopAction {
    public SwitchWallpaperAction(DesktopShortcutsLayer shortcutsLayer,
                                 Desktop desktop
    ) {
        super(
