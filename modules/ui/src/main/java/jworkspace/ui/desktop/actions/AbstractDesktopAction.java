...
public abstract class AbstractDesktopAction extends AbstractDesktopShortcutAction {

    protected final Desktop desktop;

    public AbstractDesktopAction(String name,
                                 String command,
                                 KeyStroke accelerator,
                                 DesktopShortcutsLayer shortcutsLayer,
                                 Desktop desktop) {
        super(name, command, accelerator, shortcutsLayer);
