...
public class CloseAllWindowsAction extends AbstractDesktopAction {
    public CloseAllWindowsAction(DesktopShortcutsLayer shortcutsLayer,
                                 Desktop desktop
    ) {
        super(
            "Close All Windows",
            IDesktopActions.CLOSE_ALL_WINDOWS,
            null,
            shortcutsLayer,
            desktop
        );
