...
public class EnvironmentVariablesPanel extends JPanel {
    ...
    private void loadEnvironmentVariables() {
        // Use TreeMap to automatically sort environment variables alphabetically by key
        ...
        for (Map.Entry<String, String> entry : environment.entrySet()) {
            ...
            // Format paths (like PATH or Path) to be more readable
            if (key.equalsIgnoreCase("PATH") || key.toLowerCase().contains("path")) {
