 ...
 */
public class FileResourcesExplorerDialog extends ComponentDialog
    ...
    public FileResourcesExplorerDialog(Frame parent, String title) {
    ...
    protected JComponent buildDialogUI() {
        ...
        holder.add(getBrowsePanel(), BorderLayout.NORTH);
    ...
    private void setData() {
        ...
        tf.setText(Objects.requireNonNullElse(path, ""));
    }
}