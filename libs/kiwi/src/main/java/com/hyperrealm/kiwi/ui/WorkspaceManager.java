...
public class WorkspaceManager
{
  ...
  private ArrayList<WorkspaceListener> listeners;
  ...
  {
    editors = new ArrayList<WorkspaceEditor>();
  ...
  {
    Iterator<WorkspaceEditor> iter = editors.iterator();
    while(iter.hasNext())
    {
      WorkspaceEditor editor = iter.next();
  ...
  private void updateMenuHooks(WorkspaceEditor editor, boolean unhook)
  {
    synchronized(menus)
    {
      Iterator<JMenu> iter = menus.values().iterator();
      while(iter.hasNext())
      {
