                                      ...
                                      ActionListener
{
  ...
  public StatusBar(boolean showMeter)
  {
    ...
    if(showMeter)
    {
      addStatusComponent(meter = new JProgressBar(0, 100));
   ...
   * @exception IllegalArgumentException If an attempt was made to
  ...
  {
    return((meter == null) ? false : meter.isIndeterminate());
  }
