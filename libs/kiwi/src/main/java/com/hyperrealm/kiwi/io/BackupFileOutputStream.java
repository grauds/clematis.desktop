...
/**
 * A file output stream that safely overwrites an existing file. When
 ...
 *
 * @author Mark Lindner
 * @see com.hyperrealm.kiwi.io.BackupFileWriter
 * @since Kiwi 2.0
 */
...
public class BackupFileOutputStream extends FileOutputStream {
    ...
    /**
     * Create a new <code>BackupFileOutputStream</code> for the given file.
     *
     * @param file The file to write.
     * @throws java.io.FileNotFoundException If the temporary file could not be
     *                                       opened for writing.
     */
     ...
     *                                       opened for writing.
     */
    public BackupFileOutputStream(String file) throws FileNotFoundException {
        this(new File(file));
    }
    ...
    public final void close() throws IOException {
        ...
        if (backupFile.exists()) {
            if (!backupFile.delete()) {
                throw new IOException("Unable to remove backup file");
            }
        }
