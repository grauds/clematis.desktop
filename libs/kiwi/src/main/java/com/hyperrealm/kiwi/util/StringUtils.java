...
public final class StringUtils {
    ...
    public static String justify(String text, int cols) {
    ...
    public static String[] wordBreak(String text, int quoteChar) {
        if (text == null) {
            return (null);
        }
        ...
        try {
            ...
            while (st.nextToken() != StreamTokenizer.TT_EOF) {
                if ((st.ttype == StreamTokenizer.TT_WORD) || (st.ttype == quoteChar)) {
                    vec.add(st.sval);
                }
            }
