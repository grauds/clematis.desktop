...
/**
 * Profiles management of Java Workspace
 * @param <P> generic type of profile to use
 */
public interface IUserManager<P> extends IWorkspaceComponent {
     ...
     * Login procedure.
     */
    void login(P profile) throws ProfileOperationException, IOException;
