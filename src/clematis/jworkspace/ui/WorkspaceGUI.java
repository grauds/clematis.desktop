...
import jworkspace.kernel.engines.*;
import jworkspace.ui.action.*;
import jworkspace.ui.cpanel.*;
import jworkspace.ui.desktop.*;
...
public class WorkspaceGUI implements GUI
{
    ...
    public WorkspaceGUI()
    {
        ...
        UIChangeManager.setDefaultFrameIcon( rm.getImage("jw_16x16.png") );
    }
    ...
    public void load()
    {
        ...
        texture = Jimi.getImage(fileName);
        /**
         ...
         */
        ((WorkspaceFrame) getFrame()).setTexture( UIChangeManager.getDefaultTexture() );
    ...
    public void save()
    {
        ...
        try
        {
            ...
            {
                Jimi.putImage(texture, fileName);
            }
        }
        catch (JimiException ex)
        {
            WorkspaceError.exception
                    (LangResource.getString("WorkspaceGUI.saveTexture.failed"), ex);
        }
        /**
         * Save all other info
         */
