...
import kiwi.ui.DocumentBrowserFrame;
import kiwi.ui.model.DocumentDataSource;
...
public class UIActions implements IConstants
{
    ...
    public Action[] getActions()
    {
        ...
        {
            temp[i] = (Action) enum.nextElement();
        }
        return temp;
    }
    ...
    public void showHelp()
    {
        try
        {
            DocumentDataSource help_source = new DocumentDataSource(
                    Workspace.getResourceManager());
        ...
        catch (kiwi.util.ResourceNotFoundException ex)
        {
