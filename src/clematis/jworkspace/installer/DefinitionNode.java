...
import kiwi.db.DomainObject;
import kiwi.event.HierarchicalAssociationListener;
import kiwi.event.HierarchicalAssociationSupport;
import kiwi.util.KiwiUtils;
import kiwi.util.ResourceManager;
...
/**
 * Definiton node is a base class for
...
public class DefinitionNode extends DomainObject
{
    ...
    protected HierarchicalAssociationSupport hsupport;
    ...
    public DefinitionNode(DefinitionNode parent, File file)
    {
        this.parent = parent;
        this.file = file;
        hsupport = new HierarchicalAssociationSupport(this);
    }
    ...
    {
        hsupport.addHierarchicalAssociationListener(listener);
    }
    ...
    {
        hsupport.removeHierarchicalAssociationListener(listener);
    }
