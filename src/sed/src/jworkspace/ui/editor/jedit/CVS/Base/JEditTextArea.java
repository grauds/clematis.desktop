 ...
 *     + "        Workspace.logInfo(\"Hello World\");\n"
 *     + "    }\n"
 *     + "}");</pre>
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.1.1.1 2003/04/21 07:59:02 tysinsh Exp $
 */
public class JEditTextArea extends JComponent
{
  ...
  class DocumentHandler implements DocumentListener
  {
    ...
    {
      /**
       * This is a small patch for listening only for
       * events from this document.
       */
      if (evt.getDocument() != document) return;
  ...
  public void processKeyEvent(KeyEvent evt)
  {
    ...
    if (!getText().equals(initialText))
      modified = true;
    /**
     * Send update signal to listeners
     */
