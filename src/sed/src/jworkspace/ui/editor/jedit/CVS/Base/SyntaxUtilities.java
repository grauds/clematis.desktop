package jworkspace.ui.editor.jedit;
 ...
 *
 * @author Slava Pestov
 * @version $Id: SyntaxUtilities.java,v 1.1.1.1 2003/04/21 07:58:56 tysinsh Exp $
 */
public class SyntaxUtilities
{
	...
	public static SyntaxStyle[] getDefaultSyntaxStyles()
	{
		...
		styles[Token.COMMENT1] = new SyntaxStyle(new Color(0x005500),true,false);
		styles[Token.COMMENT2] = new SyntaxStyle(new Color(0x005500),true,false);
		...
		styles[Token.LABEL] = new SyntaxStyle(Color.green,false,true);
